...
class Phone implements ILogin
{
    ...
    public function login(){
        ...
        $where = 'm.del=1 and mc.phone="'.$data['phone'].'"';
        ...
        if($password != $info['password']){
            $m_member_fail->_addMemberFail($data,10025,2);#记录登录失败
        ...
        \app\common\controller\Log::addlog(['msg'=>'手机用户登录']);#添加系统日志
