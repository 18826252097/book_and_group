...
class Username implements ILogin
{
    ...
    public function login(){
        $vali_data = Login::username(); #获取验证规则
        ...
        $where = 'm.del=1 and m.username="'.$data['username'].'"';
        ...
        if($password != $info['password']){
            $m_member_fail->_addMemberFail($data,10025);#记录登录失败
        ...
        \app\common\controller\Log::addlog(['msg'=>'账号登录']);#添加系统日志
